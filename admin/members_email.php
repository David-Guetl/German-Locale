...
$locale['email_create_message'] .= "Mit freundlichen Grьяen ".$settings['siteusername'];
...
$locale['email_activate_message'] .= "Du kannst dich jetzt mit deinem gew&auml;hlten Benutzernamen und Passwort einloggen.\n\n";
$locale['email_activate_message'] .= "Mit freundlichen Grьяen ".$settings['siteusername'];

$locale['email_deactivate_subject']  = "Account Reaktivierung erforderlich bei ".$settings['sitename'];
...
$locale['email_deactivate_message'] .= "Mit freundlichen Grьяen ".$settings['siteusername'];
...
$locale['email_ban_message'] .= "Der Grund dafьr war folgender:\n";
$locale['email_ban_message'] .= "[REASON].\n";
$locale['email_ban_message'] .= "Wenn du mehr Informationen ьber diese Sperre haben mцchtest, kontaktiere bitte den Administrator der Website unter ".$settings['siteemail'].".\n\n";
$locale['email_ban_message'] .= "Mit freundlichen Grьяen ".$settings['siteusername'];

$locale['email_secban_subject']  = "Dein Account auf ".$settings['sitename']." wurde gesperrt";
$locale['email_secban_message']  = "Hallo [USER_NAME],\n\n";
$locale['email_secban_message'] .= "dein Account auf ".$settings['sitename']." wurde gesperrt, weil manche Aktivit&auml;ten im Zusammenhang mit deinem Account eine Bedrohung der Sicherheit der Website geworden sind.\n";
$locale['email_secban_message'] .= "Wenn du mehr Informationen ьber diese Sperre haben mцchtest, kontaktiere bitte den Administrator der Website unter ".$settings['siteemail'].".\n\n";
$locale['email_secban_message'] .= "Mit freundlichen Grьяen ".$settings['siteusername'];
...
$locale['email_suspend_message'] .= "Wenn du mehr Informationen ьber diese Sperre haben mцchtest, kontaktiere bitte den Administrator der Website unter ".$settings['siteemail'].".\n\n";
$locale['email_suspend_message'] .= "Mit freundlichen Grьяen ".$settings['siteusername'];
